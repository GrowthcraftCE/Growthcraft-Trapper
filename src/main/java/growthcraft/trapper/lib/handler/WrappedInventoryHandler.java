...
public class WrappedInventoryHandler implements IItemHandlerModifiable {
    private final IItemHandlerModifiable handler;
    private final Predicate<Integer> extract;
    private final BiPredicate<Integer, ItemStack> insert;

    public WrappedInventoryHandler(IItemHandlerModifiable handler, Predicate<Integer> extract,
